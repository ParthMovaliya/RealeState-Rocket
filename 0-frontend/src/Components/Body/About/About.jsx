...
const About = () => {
    return (
        <>
            ...
            <div className="steps">
                <div className="steps-heaing">About RealeState Rocket</div>
                <div className='about-body'>
                    <div className="image-text">
                        ...
                        <div className="about-image-right">
                            <p>From its inception, Property Jet Real Estate Solutions has given homeowners the option to sell their home in any circumstance or condition. All of our staff members are specialists in the field of home buying and selling, and our management team has years of industry expertise. Unlike many other businesses, Property Jet Real Estate </p><br />
                            <p>Solutions provides our sellers with an exact offer and written contract within hours of their initial inquiry, which is convenient and satisfying.</p><br />
